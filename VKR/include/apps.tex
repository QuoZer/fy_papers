...
% \begin{sideways}%
    ...
    \begin{table}[h!]
        ...
        \hline
        \multicolumn{1}{|c|}{ \textbf{Название} } & \textbf{\begin{tabular}[c]{@{}l@{}}Симуляция \\ fisheye-камер\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}Реалистичное \\ моделирование\end{tabular}} & \multicolumn{1}{|c|}{\textbf{Интеграция кода}}                                            & \textbf{Доступность}  \\ \hline
        Gazebo            & Возможна                                                                    & Возможно                                                                     & Возможна посредством ROS & Бесплатно               \\ \hline

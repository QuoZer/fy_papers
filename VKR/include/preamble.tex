...
\usepackage[cm-default]{fontspec} % XeTeX
...
\captionsetup[figure]{justification=centering, labelsep=defffis, format=plain, belowskip=-5pt, aboveskip=20pt, font={singlespacing}} % Подпись рисунка по центру
\captionsetup[table]{justification=raggedright, labelsep=defffis, format=plain, belowskip=0pt, aboveskip=20pt, singlelinecheck=false} % Подпись таблицы слева
...
\titleformat{\section}{\large\bfseries}{}{12.5mm}{\thesection\quad\textbf{#1} }  % \titleformat{\section}{}{}{12.5mm}{\centering{\thesection\quad\MakeTextUppercase{#1}}\vspace{1.5em}}

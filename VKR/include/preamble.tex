...
% \renewenvironment{equation}{\begin{oldequation}}{\end{oldequation}}
\newenvironment{eqseries}  % Отступы вокруг серий уравнений
{\vskip 0pt}
{\vskip 24pt}
...
\setlength{\cftbeforesecskip}{0pt}      % межстрочный интервал
\setlength{\cftsecindent}{5mm}          % второй уровень
\setlength{\cftsubsecindent}{10mm}      % третий уровень
...
% doi=false,  
% ]{biblatex}
% \usepackage[style=gost2003.bst , backend=bibtex8]{biblatex}
\usepackage[numbers]{natbib}
\bibliographystyle{gost2003}  % стиль библи

\setlength{\bibhang}{0pt}  % отсутпы библиографии

% Формат подрисуночных надписей
\usepackage{caption}
\RequirePackage{caption}
\DeclareCaptionLabelSeparator{defffis}{ -- } % Разделитель
\captionsetup[figure]{justification=centering, labelsep=defffis, format=plain, belowskip=-5pt, aboveskip=15pt, font={singlespacing}} % Подпись рисунка по центру
\captionsetup[table]{justification=raggedright, labelsep=defffis, format=plain, belowskip=-5pt, aboveskip=20pt, singlelinecheck=false} % Подпись таблицы слева
...
\titleformat{\section}{\vspace{-0.5em}\bfseries}{}{12.5mm}{\thesection\quad\textbf{#1} }  % \titleformat{\section}{}{}{12.5mm}{\centering{\thesection\quad\MakeTextUppercase{#1}}\vspace{1.5em}}
\titleformat{\subsection}[block]{\vspace{-0.5em}\bfseries}{}{12.5mm}{\thesubsection\quad\textbf{#1}\vspace{-0.5em}}          %
\titleformat{\subsubsection}[block]{\vspace{-0.5em}\normalsize}{}{12.5mm}{\thesubsubsection\quad#1\vspace{-0.5em}}  %\vspace{-1.5em}
...
\newcommand{\anonsection}[1]{
    ...
    \addcontentsline{toc}{section}{\hspace{-5mm}\uppercase{#1}}
}
